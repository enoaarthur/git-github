#In this scenario, we will navigate to expedia.com and first go to the "Flights" link
#fill the fields needed as departure, arrival dates of departure and return, the number
#of travellers; then we'll go to the Accomodations to select the hotel, add a flight and click
#on search button
